...
#default
load("~/OneDrive - UMC Utrecht/Documenten/Project_EvoLikelihood/PLM-likelihoods/data/OVA_V7/AntibodyForests/AF_OVA_V7_default_HC.RData") #af
af_ova <- af
rm(af)
load("~/OneDrive - UMC Utrecht/Documenten/Project_EvoLikelihood/PLM-likelihoods/data/Horns/AntibodyForests/AF_horns2020a__VDJ_RAW_default_HC.RData")
af_horns <- af
rm(af)
load("~/OneDrive - UMC Utrecht/Documenten/Project_EvoLikelihood/PLM-likelihoods/data/Bruhn/AntibodyForests/AF_Bruhn_default_HC.RData")
af_bruhn <- af
rm(af)
load("~/OneDrive - UMC Utrecht/Documenten/Project_EvoLikelihood/PLM-likelihoods/data/Kim/AntibodyForests/AF_Kim_default_HC.RData")
af_kim <- af
rm(af)
...
#MP
load("~/OneDrive - UMC Utrecht/Documenten/Project_EvoLikelihood/PLM-likelihoods/data/OVA_V7/AntibodyForests/AF_OVA_V7_MP_HC.RData") #af
af_ova <- af
rm(af)
load("~/OneDrive - UMC Utrecht/Documenten/Project_EvoLikelihood/PLM-likelihoods/data/Horns/AntibodyForests/AF_horns2020a__VDJ_RAW_MP_HC.RData")
af_horns <- af
rm(af)
load("~/OneDrive - UMC Utrecht/Documenten/Project_EvoLikelihood/PLM-likelihoods/data/Bruhn/AntibodyForests/AF_Bruhn_MP_HC.RData")
af_bruhn <- af
rm(af)
load("~/OneDrive - UMC Utrecht/Documenten/Project_EvoLikelihood/PLM-likelihoods/data/Kim/AntibodyForests/AF_Kim_MP_HC.RData")
af_kim <- af
rm(af)
