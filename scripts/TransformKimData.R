...
df<-read.delim("~/OneDrive - UMC Utrecht/Documenten/Kim/WU368_kim_et_al_nature_2022_bcr_heavy.tsv",sep="\t")
...
#save to csv
write.csv(df_elisa, file = "~/OneDrive - UMC Utrecht/Documenten/Kim/WU368_kim_bcr_heavy_elisa.csv", row.names = FALSE)
